 ...
 Context context;
  ...
  private void createAddButton(Context context) {
    ...
    public void setColors(int a,int b){
        mAddButtonColorNormal = a;
        mAddButtonColorPressed = b;
        mAddButton.setColorNormal(a);
        mAddButton.setColorPressed(b);
        mAddButton.updateBackground();
    }
  public FloatingActionButton getButtonAt(int position){
      return (FloatingActionButton)getChildAt(position);
  }
