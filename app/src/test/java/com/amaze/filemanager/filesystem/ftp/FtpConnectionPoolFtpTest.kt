...
/**
 * Unit tests for [FtpConnectionPool] with FTP connections.
 */
...
class FtpConnectionPoolFtpTest {
    ...
    fun testGetConnectionWithUrl() {
        ...
        verify(mock, atLeastOnce()).connectTimeout = FtpConnectionPool.CONNECT_TIMEOUT
    ...
    private fun createFTPClient(validUsername: String, validPassword: String): FTPClient {
        ...
        // reset(mock);
        FtpConnectionPool.ftpClientFactory =
            object : FtpConnectionPool.FTPClientFactory {
