...
import com.amaze.filemanager.filesystem.ftp.FtpConnectionPool.FTPS_URI_PREFIX
import com.amaze.filemanager.filesystem.ftp.FtpConnectionPool.FTP_URI_PREFIX
import com.amaze.filemanager.filesystem.ftp.FtpConnectionPool.SSH_URI_PREFIX
import com.amaze.filemanager.filesystem.ftp.FtpConnectionPoolFtpTest
import com.amaze.filemanager.filesystem.ftp.NetCopyClientUtils.encryptFtpPathAsNecessary
import com.amaze.filemanager.filesystem.ssh.FtpConnectionPoolSshTest
...
object TestUtils {
    ...
    fun saveFtpConnectionSettings(
        ...
        port: Int = FtpConnectionPoolFtpTest.PORT
    ) {
        ...
        fullUri.append("@${FtpConnectionPoolFtpTest.HOST}:$port")
    ...
    fun saveSshConnectionSettings(
        ...
        fullUri.append("@${FtpConnectionPoolSshTest.HOST}:${FtpConnectionPoolSshTest.PORT}")
