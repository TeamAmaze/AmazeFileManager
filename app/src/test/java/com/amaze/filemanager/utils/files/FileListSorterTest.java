...
@Config(constants = BuildConfig.class, shadows = {ShadowMultiDex.class, ShadowDateFormat.class}, maxSdk = 27)
public class FileListSorterTest {
    ...
    public void testDir0File1DirAndFile2NoDir() {
        ...
        LayoutElementParcelable file1 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc1", "C:\\AmazeFileManager\\abc1", "user",
                "symlink", "100", 123L, true,
                "1234", true,false, OpenMode.UNKNOWN);
        LayoutElementParcelable file2 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc2.txt", "C:\\AmazeFileManager\\abc2", "user",
  ...
  */
    ...
    public void testDir0File1NoDirAndFile2Dir() {
        FileListSorter fileListSorter = new FileListSorter(0,0,1);
        LayoutElementParcelable file1 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc1.txt", "C:\\AmazeFileManager\\abc1", "user",
                "symlink", "100", 123L, true,
                "1234", false,false, OpenMode.UNKNOWN);
        LayoutElementParcelable file2 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc2", "C:\\AmazeFileManager\\abc2", "user",
                "symlink", "101", 124L, true,
  ...
  // From here, use dir is not 0 or 1. -> Select dir is -1
    ...
    public void testSort0File1TitleBigger() {
        ...
        LayoutElementParcelable file1 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc1.txt", "C:\\AmazeFileManager\\abc1", "user",
                "symlink", "100", 123L, true,
                "1234", false,false, OpenMode.UNKNOWN);
        LayoutElementParcelable file2 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc.txt", "C:\\AmazeFileManager\\abc", "user",
                "symlink", "101", 124L, true,
                "1235", false,false, OpenMode.UNKNOWN);
    ...
    public void testSort0File2TitleBigger() {
        FileListSorter fileListSorter = new FileListSorter(-1,0,1);
        LayoutElementParcelable file1 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc.txt", "C:\\AmazeFileManager\\abc", "user",
                "symlink", "100", 123L, true,
                "1234", false,false, OpenMode.UNKNOWN);
        LayoutElementParcelable file2 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc2.txt", "C:\\AmazeFileManager\\abc2", "user",
                "symlink", "101", 124L, true,
    ...
    public void testSort2File1DirAndFile2TitleBigger() {
        FileListSorter fileListSorter = new FileListSorter(-1,2,1);
        LayoutElementParcelable file1 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc", "C:\\AmazeFileManager\\abc", "user",
                "symlink", "100", 123L, true,
                "1234", true,false, OpenMode.UNKNOWN);
        LayoutElementParcelable file2 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc2.txt", "C:\\AmazeFileManager\\abc2", "user",
                "symlink", "101", 124L, true,
    ...
    public void testSort2File2DirAndFile1TitleBigger() {
        ...
        LayoutElementParcelable file1 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc1.txt", "C:\\AmazeFileManager\\abc1", "user",
                "symlink", "101", 124L, true,
                "1234", false,false, OpenMode.UNKNOWN);
        LayoutElementParcelable file2 = new LayoutElementParcelable(RuntimeEnvironment.application, "abc", "C:\\AmazeFileManager\\abc", "user",
                "symlink", "100", 123L, true,
                "1234", true,false, OpenMode.UNKNOWN);
