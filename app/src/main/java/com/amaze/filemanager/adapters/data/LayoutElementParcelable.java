...
public class LayoutElementParcelable implements Parcelable {
    ...
    public final String dateModificationAndItemsCount;
    ...
    public LayoutElementParcelable(
        ...
        if (!date.trim().equals("")) {
            ...
            this.dateModificationAndItemsCount = Utils.getDate(c, this.date);
        } else {
            this.date = 0;
            this.dateModificationAndItemsCount = "";
        }
        this.isBack = isBack;
    }
    ...
    public LayoutElementParcelable(Parcel im) {
        ...
        header = i != 0;
        isDirectory = j != 0;
        dateModificationAndItemsCount = im.readString();
        size = im.readString();
    ...
    public void writeToParcel(Parcel p1, int p2) {
        ...
        p1.writeString(dateModificationAndItemsCount);
        p1.writeString(size);
