...
public class CloudIconModelLoader implements ModelLoader<IconDataParcelable, Bitmap> {
  ...
  public LoadData<Bitmap> buildLoadData(
      IconDataParcelable iconData, int width, int height, Options options) {
    ...
    return new LoadData<>(
        ...
        new CloudIconDataFetcher(context, iconData.path, iconData.cloudFileId, width, height));
  }

  @Override
  public boolean handles(IconDataParcelable iconData) {
    String s = iconData.path;
