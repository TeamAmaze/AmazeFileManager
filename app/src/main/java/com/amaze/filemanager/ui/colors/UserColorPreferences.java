...
public final class UserColorPreferences implements Parcelable {
    ...
    public final @ColorInt int primaryFirstTab, primarySecondTab, accent, iconSkin, currentTab;

    public UserColorPreferences(@ColorInt int primaryFirstTab, @ColorInt int primarySecondTab,
                                @ColorInt int accent, @ColorInt int iconSkin, @ColorInt int currentTab) {
