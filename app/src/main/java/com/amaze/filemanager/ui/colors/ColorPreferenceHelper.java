...
public class ColorPreferenceHelper {
    ...
    public static final @ColorRes int DEFAULT_PRIMARY_FIRST_TAB = R.color.primary_indigo,
            ...
            DEFAULT_CURRENT_TAB = R.color.primary_pink;
    ...
    public static UserColorPreferences randomize(Context c) {
        ...
        return new UserColorPreferences(Utils.getColor(c, colorPos[0]), Utils.getColor(c, colorPos[0]),
                Utils.getColor(c, colorPos[1]), Utils.getColor(c, colorPos[2]), Utils.getColor(c, DEFAULT_CURRENT_TAB));
    }
    ...
    public void saveColorPreferences(SharedPreferences prefs, UserColorPreferences userPrefs) {
        ...
        editor.putInt(PreferencesConstants.PREFERENCE_CURRENT_TAB, userPrefs.currentTab);
        editor.apply();
    ...
    private UserColorPreferences getColorPreferences(Context c, SharedPreferences prefs) {
        ...
        int currentTab = prefs.getInt(PreferencesConstants.PREFERENCE_CURRENT_TAB, Utils.getColor(c, DEFAULT_CURRENT_TAB));

        return new UserColorPreferences(tabOne, tabTwo, accent, iconSkin, currentTab);
    }
    ...
    private boolean isUsingOldColorsSystem(SharedPreferences prefs) {
        ...
        int currentTab = prefs.getInt(PreferencesConstants.PREFERENCE_CURRENT_TAB, R.color.primary_pink);

        boolean r1 = tabOne >= 0 && tabTwo >= 0 && accent >= 0 && iconSkin >= 0 && currentTab >= 0;
        boolean r2 = tabOne < 22 && tabTwo < 22 && accent < 22 && iconSkin < 22 && currentTab < 22;
        return r1 && r2;
    }
    ...
    private void correctToNewColorsSystem(Context c, SharedPreferences prefs) {
        ...
        int currentTab = prefs.getInt(PreferencesConstants.PREFERENCE_CURRENT_TAB, -1);
        ...
        editor.putInt(PreferencesConstants.PREFERENCE_CURRENT_TAB, correctForIndex(c, currentTab));
        editor.apply();
    }
