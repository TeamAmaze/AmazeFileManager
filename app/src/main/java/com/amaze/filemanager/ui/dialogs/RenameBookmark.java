...
public class RenameBookmark extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (dataUtils.containsBooks(new String[]{title, path}) != -1) {
            ...
            final String s1 = getString(R.string.cantbeempty, c.getResources().getString(R.string.name));
            final String s2 = getString(R.string.cantbeempty, c.getResources().getString(R.string.path));
