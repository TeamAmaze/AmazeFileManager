    ...
    public ActionMode.Callback mActionModeCallback =
          ...
          */
                ...
                public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                    ...
                    initMenu(menu);
                    MenuItem addToCopyListMenuItem = menu.findItem(R.id.add_cpy_list);
                    MenuItem addToCutListMenuItem = menu.findItem(R.id.add_cut_list);
                    addToCopyListMenuItem.setVisible(false);
                    addToCutListMenuItem.setVisible(false);
                    if (getMainActivity().getPendingForPaste().get()){
                        if (getMainActivity().getPaste().getOperation() == PasteHelper.OPERATION_COPY)
