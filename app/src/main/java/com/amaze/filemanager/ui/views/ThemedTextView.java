 ...
 * To be used only under themed activity context
 */
public class ThemedTextView extends AppCompatTextView {

  public ThemedTextView(Context context, AttributeSet attrs) {
    super(context, attrs);
    if (((ThemedActivity) AppConfig.getInstance().getThemedActivityContext()).getAppTheme().equals(AppTheme.LIGHT)) {
      setTextColor(Utils.getColor(getContext(), android.R.color.black));
    } else if (((ThemedActivity) AppConfig.getInstance().getThemedActivityContext()).getAppTheme().equals(AppTheme.DARK)
        || ((ThemedActivity) AppConfig.getInstance().getThemedActivityContext()).getAppTheme().equals(AppTheme.BLACK)) {
