...
public abstract class AbstractProgressiveService extends Service
   ...
   * ServiceWatcherUtil} while {@link MainActivity#runOnUiThread(Runnable)} is executing the
   * callbacks in {@link ProcessViewerFragment}
   */
   ...
   * modifying the list by {@link ServiceWatcherUtil} while {@link
