...
class FtpService : Service(), Runnable {
    ...
    companion object {
        ...
        object FtpServerSslKeyStoreProvider {
            private const val FTPS_KEY_ALIAS = "ftpserver"
            private const val FTPS_KEY_DN = "CN=localhost"
            ...
            fun getKeyStore(): KeyStore {
                ...
                try {
                    if (keyStore.containsAlias(FTPS_KEY_ALIAS)) {
                        val existingEntry = keyStore.getEntry(FTPS_KEY_ALIAS, null)
            ...
            private fun generateFtpsCertificate(keyStore: KeyStore) {
                ...
                keyStore.setEntry(FTPS_KEY_ALIAS, privateKeyEntry, null)

                log.info("Generated new FTPS self-signed certificate for alias: $FTPS_KEY_ALIAS")
            }
