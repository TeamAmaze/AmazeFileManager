...
public class LoadFilesListTask
    ...
    @Override
    protected @Nullable
    Pair<OpenMode, ArrayList<LayoutElementParcelable>> doInBackground(Void... p) {
    ...
    private @Nullable
    LayoutElementParcelable createListParcelables(HybridFileParcelable baseFile) {
    ...
    private @Nullable
    ArrayList<LayoutElementParcelable> listMediaCommon(
    ...
    private @Nullable
    ArrayList<LayoutElementParcelable> listDocs() {
        final Context context = this.context.get();
    ...
    private @Nullable
    ArrayList<LayoutElementParcelable> listApks() {
        final Context context = this.context.get();
    ...
    private @Nullable
    ArrayList<LayoutElementParcelable> listRecent() {
        final MainFragment mainFragment = this.mainFragmentReference.get();
        if (mainFragment == null) {
            cancel(true);
            return null;
    ...
    private @Nullable
    ArrayList<LayoutElementParcelable> listRecentFiles() {
        final Context context = this.context.get();
