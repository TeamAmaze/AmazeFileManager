...
public class MainActivityHelper {
    ...
    private static MainActivityHelper INSTANCE = new MainActivityHelper();
    ...
    public static MainActivityHelper getInstance(MainActivity mainActivity) {
        INSTANCE.mainActivity = mainActivity;
        INSTANCE.accentColor = mainActivity.getAccent();
        return INSTANCE;
    }
    ...
    public @FolderState
    int checkFolder(final File folder, Context context) {
        return checkFolder(folder.getAbsolutePath(), OpenMode.FILE, context);
    }

    public @FolderState
    int checkFolder(final String path, OpenMode openMode, Context context) {
