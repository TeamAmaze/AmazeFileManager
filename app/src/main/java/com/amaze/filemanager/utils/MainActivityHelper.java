...
public class MainActivityHelper {
    ...
    public void showFailedOperationDialog(ArrayList<BaseFile> failedOps, boolean move,
        ...
        mat.positiveColor(Color.parseColor(ThemedActivity.accentSkin));
    ...
    public void guideDialogForLEXA(String path) {
        ...
        x.positiveColor(Color.parseColor(ThemedActivity.accentSkin));
        x.negativeColor(Color.parseColor(ThemedActivity.accentSkin));
    ...
    public static void requestAccountsPermission(final Activity activity) {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity,
            ...
            String fab_skin = (ThemedActivity.accentSkin);
