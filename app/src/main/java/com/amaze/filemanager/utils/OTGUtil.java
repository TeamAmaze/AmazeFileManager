...
public class OTGUtil {
     ...
     */
    public static ArrayList<BaseFileParcelable> getDocumentFilesList(String path, Context context) {
        ...
        for (DocumentFile file : rootUri.listFiles()) {
            try {
                if (file.exists()) {
                    ...
                    BaseFileParcelable baseFile = new BaseFileParcelable(path + "/" + file.getName(),
