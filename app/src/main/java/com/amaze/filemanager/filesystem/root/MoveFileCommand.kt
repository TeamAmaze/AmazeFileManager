...
import com.amaze.filemanager.filesystem.root.api.IMoveFileCommand

object MoveFileCommand : IMoveFileCommand {

    @Throws(ShellNotRunningException::class)
    override fun moveFile(path: String, destination: String) {
