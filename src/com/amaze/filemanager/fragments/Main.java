...
import com.amaze.filemanager.utils.GridViewWithHeaderAndFooter;
...
import com.amaze.filemanager.utils.QuickReturnListView;
...
public class Main extends android.support.v4.app.Fragment {
 ...
 //       tag=getArguments().getString("tag");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        listView = (QuickReturnListView) rootView.findViewById(R.id.listView);
        gridView = (GridViewWithHeaderAndFooter) rootView.findViewById(R.id.gridView);
        final View mQuickReturnView= rootView.findViewById(R.id.buttonbarframe);
        ...
        // app bar
        LinearLayout linearLayout1 = (LinearLayout) rootView.findViewById(R.id.pathbar);
        ...
        // app bar
        //final
        final View v= inflater.inflate(R.layout.empty,null);
