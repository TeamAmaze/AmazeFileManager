...
getActivity().findViewById(R.id.buttons).setVisibility(View.GONE);
	...
	{	ArrayList<Layoutelements> a=new ArrayList<Layoutelements>();
		...
		List<ApplicationInfo> all_apps = getActivity().getPackageManager().getInstalledApplications(PackageManager.GET_META_DATA);
			...
			}catch(Exception e){Toast.makeText(getActivity(),""+e,Toast.LENGTH_LONG).show();}//ArrayAdapter<String> b=new ArrayAdapter<String>(getActivity(),android.R.layout.simple_list_item_1,a);
			// TODO: Implement this method
