...
void putColor(String x,float a,float b,float c){colors.put(x,new Float[]{a,b,c});}
    void putColors(){
        ...
        putColor("#0288d1",0.01176471f,0.6627451f,0.95686275f);
        putColor("#0097a7",0.0f,0.7372549f,0.83137255f);
        ...
        putColor("#ffa000",1.0f,0.75686275f,0.02745098f);
        putColor("#f57c00",0.98f,0.496f,0.0f);
        putColor("#e64a19",1.0f,0.34117647f,0.1333333f);
        putColor("#795548",0.4745098f,0.3333f,0.28235294f);
        putColor("#212121",0.132f,0.132f,0.132f);
